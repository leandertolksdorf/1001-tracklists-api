...
class Tracklist:
    ...
    DJs : list[str] # TODO make DJ class
...
class Artist:
    ...
    Methods
    -------
    fetch() # TODO load details from artist page, including country/countries, member artists, etc.
    """
...
class Label:
    ...
    Methods
    -------
    fetch() # TODO load details from label page, including country, external links, etc.
    """
